import eu.interiot.translators.syntax.SEAMS2.SEAMS2TranslatorV1;
 ...
 */
public class SEAMSDemonstration {

    public static void main(String[] args) throws Exception {

        File resourcesDirectory = new File("src/test/resources/SEAMS2");
        ...
        SEAMS2TranslatorV1 translator = new SEAMS2TranslatorV1();
