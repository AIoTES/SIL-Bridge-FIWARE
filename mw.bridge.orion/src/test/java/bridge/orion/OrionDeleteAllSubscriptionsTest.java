...
//TODO FF 20.9.2017, refactor
		/*
		try {
			OrionBridge bridge = new OrionBridge(Context.getConfiguration(), new Platform(new PlatformId("Test_Orion"), "Test", new PlatformType("FIWARE"), null, null));
			bridge.cleanSubscriptions();
